...
Who has money, how they got it, and what it buys. Wars cost gold. Politics cost more.
...
- Decorative, minor function
- Value: 10-100 crowns
- Who buys: collectors, minor nobles, merchants

**Functional Artifacts** (uncommon)
- Actually do something useful
- Value: 100-1,000 crowns
- Who buys: wealthy, scholars, governments

**Major Artifacts** (rare)
- Significant power or knowledge
- Value: 1,000-10,000 crowns
- Who buys: governments, Banking Houses, secret societies

**Legendary Artifacts** (unique)
- Crown of Seeing, Mind Codex, etc.
- Value: Priceless / will start wars
- Who buys: Not for sale (supposedly)

### Who Controls Trade

**Maritime Republic Banking Houses**
- Control ~60% of artifact trade
- Finance expeditions, take percentage
- Have warehouses, appraisers, security
- Set market prices

**Free Cities Dealers**
- Control ~25% of trade
- Less formal, more illegal
- Will sell anything to anyone
- No questions asked

**Government Seizures**
- Control ~10%
- Confiscated or found on own territory
- Usually kept, sometimes sold secretly
...
### House Goldveil (Oldest)

**Founded**: Year 320
**Headquarters**: Freeport
**Assets**: ~3 million crowns

**Character**
- Traditional, cautious, legitimate
- Old money, old families
- Values reputation above profit (sometimes)

**What They Finance**
- Conservative expeditions
- Government bonds
- Major trading companies
- Nothing too risky

**Current Leader**: Director Vera Goldveil
- Age 75, matriarch
- Sees coup as dangerous to stability
- Joined Consortium reluctantly
- May switch sides if Stormwind wins

---

### House Blackwater (Richest)

**Founded**: Year 620 (Sera Blackwater's descendants)
**Headquarters**: Freeport
**Assets**: ~5 million crowns

**Character**
- Aggressive, ruthless, profit-focused
- New money energy despite old name
- Values only wealth

**What They Finance**
- Risky expeditions (high return)
- Arms deals
- Piracy (quietly)
- Anything profitable

**Current Leader**: Master Erasmus Blackwater
- Age 52, brilliant and cold
- Drove the coup
- Wants total control of artifact trade
- Will destroy anyone in his way

---

### House Ironmark (Most Aggressive)

**Founded**: Year 980
**Headquarters**: Freeport
**Assets**: ~2 million crowns

**Character**
- Young house, hungry
- Will take risks others won't
- Expanding fast
- Making enemies faster

**What They Finance**
- Dangerous expeditions (into the Scar, even)
- Weapons research
- Assassinations (probably)
- Revolution (definitely)

**Current Leader**: Chancellor Kira Ironmark
- Age 35, ambitious, dangerous
- Wants Ironmark to dominate
- Using coup to position against other Houses
- May betray Consortium for advantage

---

### Relationships Between Houses

**Goldveil vs Blackwater**
- Old rivalry
- Goldveil: "They're vulgar"
- Blackwater: "They're weak"
- Currently allies of necessity

**Goldveil vs Ironmark**
- Generational conflict
- Goldveil: "They're reckless"
- Ironmark: "They're fossils"
- Barely tolerated

**Blackwater vs Ironmark**
- Competition
- Blackwater: "They're useful... for now"
- Ironmark: "They're the target"
- Will fight eventually
...
**Assets**: ~1.5 million crowns
**Income**: Mining (dwarven trade), agriculture, taxes

**What They Buy**
- Weapons
- Artifacts (for military)
- Information
- Mercenaries

**Economic Strategy**
- Building war chest
- Quietly acquiring artifacts
- Funding agents everywhere
- Preparing for expansion

### Valdrian Imperial Treasury

**Assets**: ~2 million crowns (but in crisis)
**Income**: Trade taxes, agriculture, artifact permits

**What They Buy**
- Everything (expensive empire)
- Succession is draining reserves
- Factions spending against each other
- Money running out

**Economic Strategy**
- Survival
- Each faction hoarding
- Selling state assets
- Borrowing from Banking Houses (mistake)

### Ironpeak Confederation Treasury

**Assets**: Unknown (dwarves don't share)
**Income**: Mining, metalwork, artifact crafting

**What They Buy**
- Nothing they can make themselves
- Information
- Rare materials
- Secrecy
...
**Economic Strategy**
- Self-sufficiency
- Control of certain artifact types
...
**Income**: Tithes, donations, land rents

**What They Buy**
- Order of Dawn operations
- "Charitable works"
- Political influence
- Artifact destruction (and acquisition)
...
**Stage 1: Financing**
- Someone finds a site
- Goes to Banking House
- House finances expedition
- Takes 50-70% of finds
...
- Some to collectors
- Some to governments
- Some to secret societies
- Some disappear

### Costs

**Small Expedition** (5-10 people, minor site)
- Cost: 500-1,000 crowns
- Expected return: 1,000-5,000 crowns
- Risk: moderate

**Major Expedition** (20-50 people, significant site)
- Cost: 5,000-10,000 crowns
- Expected return: 20,000-100,000 crowns
- Risk: high (many don't return)

**Legendary Expedition** (deep site, real danger)
- Cost: 50,000+ crowns
- Expected return: Unknown
- Risk: most people die

### Who Gets Rich

**The Houses**: Always
**Successful Expedition Leaders**: Sometimes
**Team Members**: Rarely
**Scholarship**: Never
...
**Valdrian Council Vote**: 5,000-20,000 crowns
**Northern Official Bribe**: 1,000-5,000 crowns
**Church "Donation"**: 500-10,000 crowns
**Assassination**: 100-5,000 crowns (depending on target)
...
**Rumor**: 1-10 crowns
**Specific Information**: 10-100 crowns
**Secret**: 100-1,000 crowns
**Classified Government Information**: 1,000-10,000 crowns
**Location of Major Artifact**: Priceless
...
**Economic Impact**
- Factions spending reserves on bribes, mercenaries
- Uncertainty stopping investment
- Banking Houses calling in loans
- Treasury depleted

**Who Benefits**
- Banking Houses (lending at high interest)
- Northern Kingdom (buying influence cheap)
- Mercenaries (lots of work)
...
- Insurance rates up
- Some routes closed
- Artifact prices volatile

**Who Benefits**
- Banking Houses (they caused it)
- Pirates (chaos)
- Northern Kingdom (disrupted rival)

### The Sanctified Persecution

**Economic Impact**
- Scholars fleeing with knowledge
- Research stopped
- Some artifacts destroyed
- Markets nervous

**Who Benefits**
- Black market (forbidden goods valuable)
- Free Cities (refugees bring knowledge)
- No one, really
...
**To Banking Houses**: Priceless
- Living artifact
- Source of information
- Could operate other artifacts
- Could be... sold

**To Governments**: Priceless
- Weapon
- Symbol
- Source of power
- Legitimacy (or illegitimacy)

**To Secret Societies**: Priceless
- Answers to questions
- Living proof of theories
- Tool or ally
- The thing they've sought
...
**The Question**
- Everyone will try to buy him
- Everyone will try to own him
- No one will pay what he's actually worth
- Because they don't see him as a person

---

## Cross-References

- [Maritime Republic](../04-factions/empires/maritime-republic.md)
- [Present-Day Crises](present-day-crises.md)
- [Artifact Histories](../07-artifacts-magic/artifact-histories.md)

---

*Money is power. More than swords, more than magic. The Banking Houses have more wealth than kingdoms. They finance wars, buy governments, control information. When Seven wakes, he's the most valuable object in the world. Object—not person. Everyone will put a price on him. Everyone will try to pay it. His first challenge is not being sold. His second is understanding that money isn't just coins—it's everything that makes the world work. And he has none.*
